...
public class Points {
	...
	public String check() {
		...
		if (ok) {
			...
			return "\"" + label
					+ "\" must contain at least 10 x-y-value pairs.";
		}
	}
	...
	public String getText() {
		String x = "0.003125 -0.125" + "0.003125 -0.1333333333333333"
				+ "0.009375 -0.1166666666666667"
				+ "0.01875 -0.10833333333333339" + "0.025 -0.10833333333333339"
				+ "0.028125 -0.10833333333333339"
				+ "0.034375 -0.1166666666666667"
				+ "0.040625 -0.1166666666666667" + "0.05 -0.125"
				+ "0.053125 -0.125" + "0.0625 -0.1333333333333333"
				+ "0.0875 -0.1499999999999999" + "0.1 -0.15833333333333344"
				+ "0.121875 -0.16666666666666674"
				+ "0.13125 -0.17500000000000004"
				+ "0.1625 -0.17500000000000004"
				+ "0.178125 -0.16666666666666674"
				+ "0.203125 -0.1416666666666666"
				+ "0.23125 -0.10000000000000009" + "0.25 -0.08333333333333326";
	...
	private RealPoint[] read(String s) {
		...
		try {
			...
			} while (count < MAX_NR_OF_FITNESS_CASES
