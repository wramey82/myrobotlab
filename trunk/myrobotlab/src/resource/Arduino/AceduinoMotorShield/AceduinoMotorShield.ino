...
#define ACEDUINO_MOTOR_SHIELD_START 50
#define ACEDUINO_MOTOR_SHIELD_STOP 51
#define ACEDUINO_MOTOR_SHIELD_SERVO_SET_POSITION 52	
#define ACEDUINO_MOTOR_SHIELD_SERVO_SET_MIN_BOUNDS 53
#define ACEDUINO_MOTOR_SHIELD_SERVO_SET_MAX_BOUNDS 54
...
*/
        ...
        switch (ioCommand[0])
        {
           ...
           case SET_ANALOG_TRIGGER:
             ...
             ++analogReadPollingPinCount;
           break;
           case ACEDUINO_MOTOR_SHIELD_START:
           	servos.start();
           break;
           case ACEDUINO_MOTOR_SHIELD_STOP:
           	servos.stop();
           break;
           case ACEDUINO_MOTOR_SHIELD_SERVO_SET_POSITION:
           	servos.setposition(ioCommand[1], ioCommand[2]);
           break;
           case ACEDUINO_MOTOR_SHIELD_SERVO_SET_MIN_BOUNDS:
           	lastMinBounds = ioCommand[2];
           	servos.setbounds(ioCommand[1], lastMinBounds, lastMaxBounds);
           break;
           case ACEDUINO_MOTOR_SHIELD_SERVO_SET_MAX_BOUNDS:
           	lastMaxBounds = ioCommand[2];
           	servos.setbounds(ioCommand[1], lastMinBounds, lastMaxBounds);
           break;
           /////////////ACEDUINO END////////////
