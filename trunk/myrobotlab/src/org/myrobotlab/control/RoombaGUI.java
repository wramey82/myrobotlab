...
public class RoombaGUI extends ServiceGUI implements ListSelectionListener, ActionListener, ChangeListener, KeyListener {
   ...
   //RoombaCommSerial roombacomm; // in MRL'land can't have direct access to this - must message it
    Roomba roombacomm; // in MRL'land can't have direct access to this - must message it
    ...
    void makeCtrlPanel() {
        ...
        JButton but_turnleft =
            new JButton(createImageIcon("but_turnleft.png","turnleft"));
        ctrlPanel1.add( but_turnleft );
        JButton but_forward =
            new JButton(createImageIcon("but_forward.png","forward"));
        ctrlPanel1.add( but_forward );
        JButton but_turnright =
            new JButton(createImageIcon("but_turnright.png","turnright"));
        ctrlPanel1.add( but_turnright );

        JButton but_spinleft =
            new JButton(createImageIcon("but_spinleft.png","spinleft"));
        ctrlPanel1.add( but_spinleft );
        JButton but_stop =
            new JButton(createImageIcon("but_stop.png", "stop"));
        ctrlPanel1.add( but_stop );
        JButton but_spinright =
            new JButton(createImageIcon("but_spinright.png","spinright"));
        ctrlPanel1.add( but_spinright );

        ctrlPanel1.add(new JLabel());
        JButton but_backward =
            new JButton(createImageIcon("but_backward.png","backward"));
