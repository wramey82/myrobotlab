...
public class DigitalButton extends JButton{
	...
	public DigitalButton(Object parent, 
			String offText, String offCMD, Icon offIcon, Color offBGColor, Color offFGColor,
			String onText, String onCMD, Icon onIcon, Color onBGColor, Color onFGColor,
			int type) 
	{
		super(offText);
	...
	public DigitalButton(Object parent, String offCMD, ImageIcon offIcon, String onCMD, ImageIcon onIcon, int type) {
		this(parent, 
				null,  offCMD,  offIcon, null, null,
				null, onCMD, onIcon, null, null,
				 type);
	}
