...
public class ToyGUI extends ServiceGUI implements ListSelectionListener {

	public final static Logger log = LoggerFactory.getLogger(ToyGUI.class.getCanonicalName());
	...
	public ToyGUI(final String boundServiceName, final GUIService myService, final JTabbedPane tabs) {
