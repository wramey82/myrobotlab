...
public class Client extends JApplet {
	...
	public void init() {
		...
		try {
			 ...
			 * cfg.setRoot(appletAddress.getHostName()); cfg.set("servicePort",
			 * 0); // Applet - can not have a service port
			 */
			// TODO - hardcode set GUIService to display only appropriate
			// components !!!
			guiService = new GUIService(appletAddress.getHostName() + " gui");
	...
	private JPanel getJContentPane() {
		if (jContentPane == null) {
			...
			jContentPane.add(guiService.panel);
		}
		return jContentPane;
	}
