...
public class PID extends Service {
	...
	private long sampleTime = 100;	//default Controller Sample Time is 0.1 seconds
	...
	void init()
	{
	   ...
	   lastTime = System.currentTimeMillis()-sampleTime;  // FIXME - is this correct ??? (was in constructor)
	}
	...
	public String getToolTip() {
		return "<html>a PID control service from<br>"
	...
	int getMode(){ return  inAuto ? MODE_AUTOMATIC : MODE_MANUAL;}
