...
//  private String preprocName; 
  ...
  protected void copyTo(File dest) throws IOException {
	  ArduinoGUI.saveFile(program, dest);
  }
  ...
  public int getLineCount() {
    return ArduinoGUI.countLines(program);
  }
...
//  }
  ...
  public void load() throws IOException {
    //program = ArduinoGUI.loadFile(file);
	  program = FileIO.fileToString(file);
  ...
  public void save() throws IOException {
    ...
    //history.record(s, SketchHistory.SAVE);
	  ...
	  ArduinoGUI.saveFile(program, file);
    setModified(false);
  }
  ...
  public void saveAs(File newFile) throws IOException {
	  ArduinoGUI.saveFile(program, newFile);
  }
}
