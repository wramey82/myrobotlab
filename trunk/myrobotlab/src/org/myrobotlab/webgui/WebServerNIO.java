 ...
 * @author md_5
 */
public class WebServerNIO implements Runnable {
     ...
     */
    protected WebServerNIO(InetSocketAddress address) throws IOException {
    ...
    public static void main(String[] args) throws Exception {
        WebServerNIO server = new WebServerNIO(new InetSocketAddress(5555));
        while (true) {
            server.run();
            Thread.sleep(100);
        }
