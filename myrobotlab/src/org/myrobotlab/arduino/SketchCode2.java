...
//  private String preprocName; 
  ...
  public SketchCode2(File file, String extension) {
    this.file = file;
...
/*
  ...
  */
  ...
  public void setState(String p, int start, int stop, int pos) {
    program = p;
