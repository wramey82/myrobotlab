...
public class JoystickGUI extends ServiceGUI implements ActionListener{
	...
	public void init() {
		...
		output.add(hatTransform, gc); ++gc.gridx;
		output.add(new JLabel(" Hat ", SwingConstants.LEFT), gc); ++gc.gridx;
		output.add(new JLabel(" X "), gc); ++gc.gridx;
		output.add(hatMultiplier, gc); ++gc.gridx;
		output.add(new JLabel(" + "), gc); ++gc.gridx;
		output.add(hatOffset, gc); ++gc.gridx;
		output.add(new JLabel(" = "), gc); ++gc.gridx;
		output.add(hatOutput, gc); ++gc.gridx;
		
		gc.gridx=0;++gc.gridy;
		output.add(XAxisTransform, gc); ++gc.gridx;
		output.add(new JLabel(" X Axis ", SwingConstants.LEFT), gc); ++gc.gridx;
		output.add(new JLabel(" X "), gc); ++gc.gridx;
		output.add(XAxisMultiplier, gc); ++gc.gridx;
		output.add(new JLabel(" + "), gc); ++gc.gridx;
		output.add(XAxisOffset, gc); ++gc.gridx;
		output.add(new JLabel(" = "), gc); ++gc.gridx;
		output.add(XAxisOutput, gc); ++gc.gridx;

		gc.gridx=0;++gc.gridy;
		output.add(YAxisTransform, gc); ++gc.gridx;
		output.add(new JLabel(" Y Axis ", SwingConstants.LEFT), gc); ++gc.gridx;
		output.add(new JLabel(" X "), gc); ++gc.gridx;
		output.add(YAxisMultiplier, gc); ++gc.gridx;
		output.add(new JLabel(" + "), gc); ++gc.gridx;
		output.add(YAxisOffset, gc); ++gc.gridx;
		output.add(new JLabel(" = "), gc); ++gc.gridx;
		output.add(YAxisOutput, gc); ++gc.gridx;

		gc.gridx=0;++gc.gridy;
		output.add(ZRotTransform, gc); ++gc.gridx;
		output.add(new JLabel(" Z Rotation ", SwingConstants.LEFT), gc); ++gc.gridx;
		output.add(new JLabel(" X "), gc); ++gc.gridx;
		output.add(ZRotMultiplier, gc); ++gc.gridx;
		output.add(new JLabel(" + "), gc); ++gc.gridx;
		output.add(ZRotOffset, gc); ++gc.gridx;
		output.add(new JLabel(" = "), gc); ++gc.gridx;
		output.add(ZRotOutput, gc); ++gc.gridx;
		
		gc.gridx=0;++gc.gridy;
		output.add(ZAxisTransform, gc); ++gc.gridx;
		output.add(new JLabel(" Z Axis ", SwingConstants.LEFT), gc); ++gc.gridx;
		output.add(new JLabel(" X "), gc); ++gc.gridx;
		output.add(ZAxisMultiplier, gc); ++gc.gridx;
		output.add(new JLabel(" + "), gc); ++gc.gridx;
		output.add(ZAxisOffset, gc); ++gc.gridx;
		output.add(new JLabel(" = "), gc); ++gc.gridx;
		output.add(ZAxisOutput, gc); ++gc.gridx;
...
/*		
		output.add(getTranformPanel("Hat        ", hatMultiplier,   hatOffset,   hatOutput));
		output.add(getTranformPanel("X Axis     ", XAxisMultiplier, XAxisOffset, XAxisOutput));
		output.add(getTranformPanel("Y Axis     ", YAxisMultiplier, YAxisOffset, YAxisOutput));
		output.add(getTranformPanel("Z Rotation ", ZRotMultiplier,  ZRotOffset,  ZRotOutput));
		output.add(getTranformPanel("ZAxis      ", ZAxisMultiplier, ZAxisOffset, ZAxisOutput));
*/		
