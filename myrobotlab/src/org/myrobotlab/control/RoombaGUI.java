...
public class RoombaGUI extends ServiceGUI implements ListSelectionListener, ActionListener, ChangeListener, KeyListener {
	 ...
	 * turns off notenum 25: blink LEDs, velcoity is color of Power LED notenum
	 * 28 & 29: spin left & spin right, velocity is speed
	 * 
	 */
	...
	void makeDisplayPanel() {
		...
		JScrollPane scrollPane = new JScrollPane(displayText, JScrollPane.VERTICAL_SCROLLBAR_ALWAYS, JScrollPane.HORIZONTAL_SCROLLBAR_NEVER);
