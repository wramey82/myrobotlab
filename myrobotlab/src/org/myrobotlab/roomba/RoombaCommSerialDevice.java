...
public class RoombaCommSerialDevice extends RoombaComm implements SerialDeviceEventListener
{
   ...
   // public OutputStream output;
	...
	public void setProtocol(String protocol) {
		...
		// writeConfigFile(portname, protocol, waitForDSR?'Y':'N'); FIXME - remove use Service.save() !
	}
	...
	public void setPortname(String p) {
		...
		//writeConfigFile(portname, protocol, waitForDSR?'Y':'N');  fixme - use Service.save()
            ...
            while (portList.hasMoreElements()) {
                ...
                if (portId.getPortType() == CommPortIdentifier.PORT_SERIAL) {
                    ...
                    if (portId.getName().equals(portname)) {
                        ...
                        port = (SerialDevice)portId.open("roomba serial", 2000);
                        //port.setFlowControlMode(SerialDevice.FLOWCONTROL_NONE);
