...
public class ServiceData {
	 ...
	 * Dependency information is stored in a normalized (TreeMap) list of Service types
	 * Each Service type can have a list of serviceInfo (many to many). 
	 * The relationships can be many to many but the actual serviceInfo have to be 
	 * normalized
	 */
	...
	// Master source is ONLY ivy resolved xml files ! no need to serialize or deserialize
