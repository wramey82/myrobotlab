...
/*
			...
			Trigger trigger = newTrigger().withIdentity("trigger1") // default group
					.startAt(runTime)
	...
	public boolean scheduleCronJob(String jobName, String triggerName, String cron)
	{
		...
		try {
			...
			Trigger cronTrigger = newTrigger()
					    .withIdentity("trigger3") // default group
					    .withSchedule(cronSchedule("0 0/2 8-17 * * ?"))
					    .forJob(j) // adding to default group
					    .build();
