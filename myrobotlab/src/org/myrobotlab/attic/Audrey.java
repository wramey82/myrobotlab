...
public class Audrey extends Service {
	...
	// Behaviors - Observing, Reporting, Moving Toy (confirmation), Taking
	// command to move,
	// States - looking for yellow blocks | looking for learning pad | looking
	// for blue blocks | looking for new things | asking questions about things
	// | making relationships with things
	//
	...
	// world-> (location-heading) myView -> objects in view / objects in memory
	// not in view
	...
	// In addition - a findObjects should be created and the robot turned into
	// an inquisitor - what is this blob - then get name
	...
	public void startRobot() {
		...
		mouth.addListener("started", ear.getName(), "stopRecording"); // TODO
																		// speak.queue()
		...
		// camera.addListener("publish", name, "publish",
		...
		/*
		 * mouth.speak("I am ready now"); mouth.speak("now I am ready, dood");
		 * mouth.speak("hello Greg"); mouth.speak("yes Grog I am listening");
		 * mouth.speak("yes, Greg"); mouth.speak("hello Grog");
		 * mouth.speak("yes Grog"); mouth.speak("yes, Grog");
		 */
	...
	public String getToolTip() {
		return "<html>Audrey is a test behavioral service, used to interface and control bug toy.<br>" + "for more information see http://myrobotlab.org/node/74</html>";
	}
