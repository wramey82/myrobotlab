...
public final class FilterColorGrouping3 extends OpenCVFilter {
	...
	public final static Logger log = Logger.getLogger(FilterColorGrouping3.class.getCanonicalName());
	...
	/*
	 * @Override public void loadDefaultConfiguration() { this.cfg = cfg; //
	 * TODO Auto-generated method stub cfg.set("target.x", 0);
	 * cfg.set("target.y", 0); cfg.set("target.width", 320);
	 * cfg.set("target.height", 240); // cfg.set("target.color", "40");
	 * 
