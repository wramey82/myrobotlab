 ...
 * Enumeration portList = SerialDeviceIdentifier.getPortIdentifiers(); while
 * (portList.hasMoreElements()) { SerialDeviceIdentifier portId =
 * (SerialDeviceIdentifier) portList.nextElement();
 * //System.out.println(portId);
 * 
 * if (portId.getPortType() == SerialDeviceIdentifier.PORT_SERIAL) { //if
