...
java -classpath "./libraries/jar/*" -Djava.library.path="./libraries/native/x86.32.linux:./libraries/native/x86.64.linux:./libraries/native/x86.32.mac" org.myrobotlab.service.Runtime -service jython Jython gui GUIService 
