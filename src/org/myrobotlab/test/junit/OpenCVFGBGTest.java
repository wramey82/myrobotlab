...
public class OpenCVFGBGTest {
	...
	public final void testOpenCV() {
		...
		// test.notify("say", audio.name, "play",
		// String.class.getCanonicalName());// THE COLOR TALKER
		...
		audio.play("green");
		/*
		 * test.setServoX(s2.name); test.setServoY(s1.name);
		 * test.setOpenCV(opencv.name);
		 * 
		 * test.start(); test.sayWhatYouFound();
		 */
		// cal.calibrate();
	...
	@Test
	public final void testPauseInteger() {
		// fail("Not yet implemented");
	}

	@Test
	public final void testLogTime() {
		// fail("Not yet implemented");
	}

	@Test
	public final void testSendImageIplImage() {
		// fail("Not yet implemented");
	}

	@Test
	public final void testSendImageBufferedImage() {
		// fail("Not yet implemented");
	}

	@Test
	public final void testSaveFeatures() {
		// fail("Not yet implemented");
	}

	@Test
	public final void testDumpFeatureData() {
		// fail("Not yet implemented");
	}

	@Test
	public final void testSaveBufferedImageBufferedImageString() {
		// fail("Not yet implemented");
	}

	@Test
	public final void testSaveBufferedImageBufferedImageStringString() {
		// fail("Not yet implemented");
	}

	@Test
	public final void testCompareFeatures() {
		// fail("Not yet implemented");
	}

	@Test
	public final void testGetFeatures() {
		// fail("Not yet implemented");
	}

	@Test
	public final void testGoodFeaturesToTrack() {
		// fail("Not yet implemented");
	}

	@Test
	public final void testInit3D() {
		// fail("Not yet implemented");
	}

	@Test
	public final void testBuildMesh() {
		// fail("Not yet implemented");
	}
